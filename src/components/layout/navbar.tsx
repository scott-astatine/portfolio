            ...
            >
                ...
                <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
                    ...
                    <MDBNavbarNav className="nav-fill" right>
                        <MDBNavItem>
                            <a className="nav-link waves-effect waves-light" href="https://www.twitter.com/WilliamAstatine"
                                target="_blank" rel="noopener noreferrer">
                                <MDBIcon fab icon="twitter" />{this.state.isOpen ? 'Twitter' : ''}
                            </a>
                        </MDBNavItem>
                        <MDBNavItem>
                            <a className="nav-link waves-effect waves-light" href="https://www.facebook.com/WilliamAstatine"
                                target="_blank" rel="noopener noreferrer">
